...
public class Woman_YOLOInference : MonoBehaviour
{
    ...
    private readonly string[] classNames = new string[] {
        "귀", "눈", "다리", "단추", "머리", "머리카락", "목", "발", "사람전체", "상체", "손", "얼굴", "여자구두", "운동화", "입", "주머니", "코", "팔"
    };
        ...
        using (var client = new HttpClient())
        {
            try
            {
                ...
                using (var content = new MultipartFormDataContent())
                {
                    ...
                    // HTTP POST 요청
                    var response = await client.PostAsync("http://pettopia.iptime.org:8001/artversAIWoman", content);
