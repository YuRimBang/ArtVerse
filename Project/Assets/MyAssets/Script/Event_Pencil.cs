...
public class Event_pencil : MonoBehaviour
{
    ...
    {
        if(leftObj != null && leftObj.CompareTag(pencilTag) && isTrigger(leftDevice))
        {
            handleSprayEvent(left);
        }
        else if (rightObj != null && rightObj.CompareTag(pencilTag) && isTrigger(rightDevice))
        {
